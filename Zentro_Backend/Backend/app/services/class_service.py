...
from ..schemas.class_schema import GymClassCreate, GymClassUpdate
...
class ClassService:
    ...
    def create_class(self, db: Session, class_in: GymClassCreate):
        return gym_class_dao.create(db, obj_in=class_in)

    def update_class(self, db: Session, class_id: int, class_in: GymClassUpdate):
